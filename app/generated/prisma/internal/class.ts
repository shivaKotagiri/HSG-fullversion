...
export interface PrismaClientConstructor {
   ...
   * // Fetch zero or more BloodDonations
...
/**
  ...
  $extends: runtime.Types.Extensions.ExtendsHook<"extends", Prisma.TypeMapCb<OmitOpts>, ExtArgs, runtime.Types.Utils.Call<Prisma.TypeMapCb<OmitOpts>, {
    extArgs: ExtArgs
      ...
      /**
   * `prisma.bloodDonation`: Exposes CRUD operations for the **BloodDonation** model.
    * Example usage:
    * ```ts
    * // Fetch zero or more BloodDonations
    * const bloodDonations = await prisma.bloodDonation.findMany()
    * ```
    */
  get bloodDonation(): Prisma.BloodDonationDelegate<ExtArgs, { omit: OmitOpts }>;
